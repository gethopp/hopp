      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="absolute top-6 right-6 inline-flex size-4 items-center justify-center border-0 bg-transparent p-0 opacity-70 outline-none ring-0 transition-opacity hover:opacity-100 focus:outline-none focus:ring-0 disabled:pointer-events-none [appearance:none] [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
